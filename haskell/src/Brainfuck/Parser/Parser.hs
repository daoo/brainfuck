...
type HappyReduction m = 
	   Int 
	-> (Char)
	-> HappyState (Char) (HappyStk HappyAbsSyn -> [(Char)] -> m HappyAbsSyn)
	-> [HappyState (Char) (HappyStk HappyAbsSyn -> [(Char)] -> m HappyAbsSyn)] 
...
action_0,
 ...
 action_12,
 action_13,
 action_14 :: () => Int -> ({-HappyReduction (HappyIdentity) = -}
	   Int 
	-> (Char)
	-> HappyState (Char) (HappyStk HappyAbsSyn -> [(Char)] -> (HappyIdentity) HappyAbsSyn)
	-> [HappyState (Char) (HappyStk HappyAbsSyn -> [(Char)] -> (HappyIdentity) HappyAbsSyn)] 
	-> HappyStk HappyAbsSyn 
	-> [(Char)] -> (HappyIdentity) HappyAbsSyn)
...
happyError' :: () => [(Char)] -> HappyIdentity a
